...
type
    TToolType=(ttline, ttrecta, ttrect,ttellipse, ttroundrect, ttspray, ttpen);
    TForm1 = class(TForm)
    MainMenu1: TMainMenu;
    Panel1: TPanel;
...
begin
Image1.Picture.SaveTofile('E:\2 семестр\Программирование в среде Delphi\Лабараторная работа 13\Фото\1.jpg');
end;
  ...
  begin
    ...
    case activeTool of
      ...
      ttRect:
        ...
        ttrecta:
        begin
           image1.canvas.Pen.Style:=pssolid;{Сплошная линия}
           image1.canvas.Pen.Color:=clwhite;
           image1.canvas.Brush.Color:=clwhite;    //цвет заливка
...
speedbutton8.Visible:=true;
activetool:=ttrecta;
statusbar1.Panels[1].Text:='Инструмент рисования: Ластик'
