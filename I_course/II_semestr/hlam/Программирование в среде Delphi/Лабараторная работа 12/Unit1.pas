...
1: Label6.Caption:='воскресенье';

2: Label6.Caption:='понедельник';

3: Label6.Caption:='вторник';

4: Label6.Caption:='среда';

5: Label6.Caption:='четверг';

6: Label6.Caption:='пятница';

7: Label6.Caption:='субботa';
