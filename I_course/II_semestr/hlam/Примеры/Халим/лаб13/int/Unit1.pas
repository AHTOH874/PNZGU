...
var c:integer;
begin
 c:=messagedlg('Завершить работу?',mtWarning,[mbYes, mbNo],0);
...
//10. Разработать программу простейшего графического редактора (аналога программы Paint системы Windows).
//Он должен рисовать в канве компонента  TpaintBox  произвольные  кривые  с  помощью  мыши.
