...
Memo1.Lines.Add('Ќаибольшее количество согласных в слове - '+mas[numberword]+'    '+ inttostr(maxsogl) ) ;
end;

procedure TForm1.Button2Click(Sender: TObject);
var c:integer;
begin
 c:=messagedlg('«авершить работу?',mtWarning,[mbYes, mbNo],0);
